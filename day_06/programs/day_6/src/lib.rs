...
declare_id!("awbq2tMQtt38zDis7nuHLtNZ1ZLWUkWYwGmcE3CH3ho");
...
pub mod day_6 {
    ...
    pub fn age_checker_if_else(_ctx: Context<Initialize>, age: u64) -> Result<()> {
        if age >= 18 {
    ...
    pub fn age_checker_ternary(_ctx: Context<Initialize>, age: u64) -> Result<()> {
    ...
    pub fn fixed_array(_ctx: Context<Initialize>) -> Result<()> {
        ...
        msg!("First element = {}", first_element);
