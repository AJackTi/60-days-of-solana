...
import { AccountInitialization } from '../target/types/account_initialization';
...
describe("account_initialization", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());

  const program = anchor.workspace
    .AccountInitialization as Program<AccountInitialization>;
  ...
  it("Is initialized!", async () => {
    ...
    await program.methods
      ...
      .signers([keypair]) // the signer must be the signer
      .rpc();
